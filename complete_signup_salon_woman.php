        ...
        <div class="services">
            ...
            <div class="services-container">
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="hairCut" <?php if ($servicesF[0] == 1) echo 'checked'; ?>>
                        <span>قص شعر</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="dryer" <?php if ($servicesF[1] == 1) echo 'checked'; ?>>
                        <span>سشوار</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="wax" <?php if ($servicesF[2] == 1) echo 'checked'; ?>>
                        <span>واكس</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="eyebrows" <?php if ($servicesF[3] == 1) echo 'checked'; ?>>
                        <span>حواجب</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="laser" <?php if ($servicesF[4] == 1) echo 'checked'; ?>>
                        <span>ليزر</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="highlight" <?php if ($servicesF[5] == 1) echo 'checked'; ?>>
                        <span>هاي لايت</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="style" <?php if ($servicesF[6] == 1) echo 'checked'; ?>>
                        <span>تسريحه</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="makeup" <?php if ($servicesF[7] == 1) echo 'checked'; ?>>
                        <span>ميك اب</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="pedicure" <?php if ($servicesF[8] == 1) echo 'checked'; ?>>
                        <span>بدكير</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="manicure" <?php if ($servicesF[9] == 1) echo 'checked'; ?>>
                        <span>منكير</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="skin" <?php if ($servicesF[10] == 1) echo 'checked'; ?>>
                ...
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="dye" <?php if ($servicesF[11] == 1) echo 'checked'; ?>>
                        <span>صبغه</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="mesh" <?php if ($servicesF[12] == 1) echo 'checked'; ?>>
                        <span>ميش</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="oil" <?php if ($servicesF[13] == 1) echo 'checked'; ?>>
                        <span>حمام زيت</span>
                    </label>
                </div>
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="protein" <?php if ($servicesF[14] == 1) echo 'checked'; ?>>
                        <span>بروتين</span>
                    </label>
                </div>
                ...
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="String" <?php if ($servicesF[15] == 1) echo 'checked'; ?>>
                ...
                <div>
                    <label>
                        <input type="checkbox" name="Services[]"
                               value="keratin" <?php if ($servicesF[16] == 1) echo 'checked'; ?>>
                        <span>كراتين</span>
                    </label>
                </div>
            </div>
