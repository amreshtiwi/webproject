                ...
                if ($res->rowCount() == 0) {
                    ...
                    for ($i = 0; $i < $res->rowCount(); $i++) {
                        ...
                        if (strpos($eachres['SalName'], $text) !== false) {
                            ...
                            $resultText = $resultText . "<div style='text-align: center; alignment: center;'> <p> " . $eachres['SalName'] . "  " . $eachres['PhoneNum'] ."</p> <img src='data:image/jpeg;base64," . $image  . " '/> </div>";
...
<div class="header">
    ...
    <form action="?" method="post">
        <div class="search_box">
            <div class="dropdown">
                <!--            <div class="default_option" >إسم الصالون</div>-->
                <!--            <ul id="filter">-->
                <!--                <li>إسم الصالون</li>-->
                <!--                <li>في المدينه</li>-->
                <!--                <li>خدمه</li>-->
